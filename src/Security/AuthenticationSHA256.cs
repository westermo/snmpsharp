...
{
    private const int authenticationLength = 24;
    ...
    /// <summary>
    ///     Verifies correct SHA-256 authentication of the frame. Prior to calling this method, you have to extract
    ///     authentication
    ...
    public byte[] ComputeHash(Span<byte> data, int offset, int count) => SHA256.HashData(data.Slice(offset, count));
}